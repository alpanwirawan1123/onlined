                        ...
                        <div class="content">
                            ...
                            <div class="card_main">
                                ...
                                <p class="card_main-text">
                                    Sed a eros sodales diam sagittis faucibus. Cras id erat nisl. Lorem tempus
                                    rhoncus sit tortor.
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="card">
                        <div class="content">
                            ...
                            <div class="card_main">
                                ...
                                <p class="card_main-text">
                                    Sed a eros sodales diam sagittis faucibus. Cras id erat nisl. Lorem ipsum dolor
                                    sit lorem amet.
                                </p>
                            </div>
                        </div>
    ...
    <section class="promo">
        <div class="container d-flex flex-column-reverse flex-lg-row justify-content-lg-end">
            <div class="promo_media">
                <lottie-player src="lottie/scene.json" background="transparent" speed="1"
                    style="width: 100%; height: 100%" loop autoplay></lottie-player>
            </div>
            <div class="promo_content">
                ...
                <p class="promo_content-text" data-aos="fade-up" data-aos-delay="50">
                    Morbi tempor eleifend condimentum. Etiam mollis urna et massa tempus vulputate. Nunc sed nisl
                    est. Donec non
                    consectetur elit. Praesent accumsan elit urna, eget mattis turpis aliquam a. In sagittis
                    bibendum consequat.
                ...
                <div class="about_review-wrapper">
                    ...
                    <div class="main">
                        ...
                        <q class="main_review quote">
                            “Mauris tellus lorem, tempus sed nibh at, varius convallis mi. sed scelerisque odio
                            neque a lacus. Ut
                        ...
                        <div class="bottom">
                            <ul class="bottom_list">
                                ...
                                <li class="bottom_list-item d-flex align-items-start">
                                    <i class="bottom_list-item_marker icon-circle"></i>
                                    <p class="bottom_list-item_text">
                                        Aenean tristique sodales enim, et consequat velit. Morbi sit amet lorem
                                        sapien
                                    </p>
                                </li>
                            </ul>
